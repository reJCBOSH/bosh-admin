...
type SysDept struct {
	...
	DeptCode     string    `gorm:"type:varchar(30) COLLATE utf8mb4_bin;not null;unique;comment:部门编码" json:"deptCode"`
	DeptPath     string    `gorm:"type:varchar(255);default:0;comment:部门路径" json:"deptPath"`
	Remark       string    `gorm:"type:varchar(200);comment:备注" json:"remark"`
	Status       int       `gorm:"type:tinyint;default:0;comment:状态 0停用 1启用" json:"status"`
