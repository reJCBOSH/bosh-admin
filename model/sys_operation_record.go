...
type SysOperationRecord struct {
	...
	Status         int    `gorm:"type:int;comment:请求状态" json:"status"`
	...
	RequestRegion  string `gorm:"type:varchar(255);comment:请求地点" json:"requestRegion"`
	RequestOS      string `gorm:"column:request_os;type:varchar(20);comment:操作系统" json:"requestOS"`
	RequestBrowser string `gorm:"type:varchar(20);comment:浏览器" json:"requestBrowser"`
