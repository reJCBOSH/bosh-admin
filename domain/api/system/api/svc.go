...
type SvcSysApi struct{}

func NewSvcSysApi() *SvcSysApi {
	return &SvcSysApi{}
}

func (svc *SvcSysApi) GetApiList(apiName, apiGroup, apiMethod, apiPath string, isRequired *int, pageNo, pageSize int) ([]model.SysApi, int64, error) {
...
func (svc *SvcSysApi) GetApiInfo(id uint) (*model.SysApi, error) {
...
func (svc *SvcSysApi) AddApi(req AddApiReq) error {
	var count int64
...
func (svc *SvcSysApi) EditApi(req EditApiReq) error {
...
func (svc *SvcSysApi) DelApi(id any) error {
	api, err := db.QueryById[model.SysApi](id)
	if err != nil {
		return exception.NewException("查询api信息失败", err)
	}
...
func (svc *SvcSysApi) GetApiGroups() ([]string, error) {
	var groups []string
