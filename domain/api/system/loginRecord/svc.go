...
type SvcSysLoginRecord struct {
}

func NewSvcSysLoginRecord() *SvcSysLoginRecord {
	return &SvcSysLoginRecord{}
}

func (svc *SvcSysLoginRecord) GetLoginRecordList(username, startTime, endTime string, status *int, pageNo, pageSize int) ([]model.SysLoginRecord, int64, error) {
...
func (svc *SvcSysLoginRecord) AddLoginRecord(uid uint, username, loginIP, userAgent string, loginStatus int) error {
...
func (svc *SvcSysLoginRecord) DelLoginRecord(id uint) error {
...
func (svc *SvcSysLoginRecord) DelLoginRecordByIds(ids []uint) error {
