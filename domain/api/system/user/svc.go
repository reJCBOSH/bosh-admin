...
type SvcSysUser struct{}

func NewSvcSysUser() *SvcSysUser {
	return &SvcSysUser{}
}

func (svc *SvcSysUser) GetUserList(username, nickname string, gender, status *int, roleId, deptId *uint, pageNo, pageSize int) ([]model.SysUser, int64, error) {
...
func (svc *SvcSysUser) GetUserById(id any) (*model.SysUser, error) {
...
func (svc *SvcSysUser) AddUser(user AddUserReq) error {
	var count int64
...
func (svc *SvcSysUser) EditUser(user EditUserReq) error {
...
func (svc *SvcSysUser) DelUser(currentUserId uint, id any) error {
	if currentUserId == id {
...
func (svc *SvcSysUser) ResetPassword(currentUserId uint, id any) error {
	if currentUserId == id {
...
func (svc *SvcSysUser) SetUserStatus(currentUserId uint, id any, status int) error {
	if currentUserId == id {
...
func (svc *SvcSysUser) EditSelfInfo(currentUserId uint, req EditSelfInfoReq) error {
...
func (svc *SvcSysUser) EditSelfPassword(currentUserId uint, req EditSelfPasswordReq) error {
