...
type SvcSysRole struct{}

func NewSvcSysRole() *SvcSysRole {
	return &SvcSysRole{}
}

func (svc *SvcSysRole) GetRoleList(roleName, roleCode string, status *int, pageNo, pageSize int) ([]model.SysRole, int64, error) {
...
func (svc *SvcSysRole) GetRoleById(id any) (*model.SysRole, error) {
...
func (svc *SvcSysRole) AddRole(role AddRoleReq) error {
	var count int64
...
func (svc *SvcSysRole) EditRole(role EditRoleReq) error {
...
func (svc *SvcSysRole) DelRole(id any) error {
...
func (svc *SvcSysRole) GetRoleMenu(roleId any) ([]model.SysMenu, error) {
...
func (svc *SvcSysRole) GetRoleMenuIds(roleId any) ([]uint, error) {
...
func (svc *SvcSysRole) SetRoleMenuAuth(roleId uint, menuIds []uint) error {
	role, err := db.QueryById[model.SysRole](roleId)
	if err != nil {
		return exception.NewException("查询角色失败", err)
	}
...
func (svc *SvcSysRole) GetRoleDeptIds(roleId any) ([]uint, error) {
	role, err := db.QueryById[model.SysRole](roleId)
	if err != nil {
		return nil, exception.NewException("查询角色失败", err)
	}
...
func (svc *SvcSysRole) SetRoleDataPerm(roleId uint, dataPerm int, deptIds []uint) error {
...
func (svc *SvcSysRole) SetRoleStatus(currentRoleId, roleId uint, status int) error {
	role, err := db.QueryById[model.SysRole](roleId)
	if err != nil {
		return exception.NewException("查询角色失败", err)
	}
