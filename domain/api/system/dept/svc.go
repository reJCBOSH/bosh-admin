...
type SvcSysDept struct{}

func NewSvcSysDept() *SvcSysDept {
	return &SvcSysDept{}
}

func (svc *SvcSysDept) GetDeptTree() ([]model.SysDept, error) {
...
func (svc *SvcSysDept) GetDeptList(deptName, deptCode string, status *int, pageNo, pageSize int) ([]model.SysDept, int64, error) {
...
func (svc *SvcSysDept) GetDeptById(id uint) (*model.SysDept, error) {
...
func (svc *SvcSysDept) AddDept(dept AddDeptReq) error {
	var count int64
...
func (svc *SvcSysDept) EditDept(dept EditDeptReq) error {
...
func (svc *SvcSysDept) DelDept(id any) error {
