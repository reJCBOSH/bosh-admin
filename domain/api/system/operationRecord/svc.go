...
type SvcSysOperationRecord struct{}

func NewSvcSysOperationRecord() *SvcSysOperationRecord {
	return &SvcSysOperationRecord{}
}

func (svc *SvcSysOperationRecord) GetOperationRecordList(username, method, path, requestIP string, status int, startTime, endTime string, pageNo, pageSize int) ([]model.SysOperationRecord, int64, error) {
...
func (svc *SvcSysOperationRecord) GetOperationRecordById(id uint) (*model.SysOperationRecord, error) {
...
func (svc *SvcSysOperationRecord) DelOperationRecord(id uint) error {
...
func (svc *SvcSysOperationRecord) BatchDelOperationRecord(ids []uint) error {
