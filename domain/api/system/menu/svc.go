...
type SvcSysMenu struct{}

func NewSvcSysMenu() *SvcSysMenu {
	return &SvcSysMenu{}
}

func (svc *SvcSysMenu) GetMenuTree() ([]model.SysMenu, error) {
...
func (svc *SvcSysMenu) GetMenuList(title string, pageNo, pageSize int) ([]model.SysMenu, int64, error) {
...
func (svc *SvcSysMenu) GetMenuById(id uint) (*model.SysMenu, error) {
...
func (svc *SvcSysMenu) AddMenu(menu AddMenuReq) error {
	var err error
	if menu.MenuType < 3 {
		var count int64
...
func (svc *SvcSysMenu) EditMenu(menu EditMenuReq) error {
...
func (svc *SvcSysMenu) DelMenu(id any) error {
...
func (svc *SvcSysMenu) GetAsyncRoutes(roleId uint, roleCode string) ([]ArtMenu, error) {
